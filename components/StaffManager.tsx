    ...
    return (
        <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
             ...
             <div className={`flex flex-col xl:flex-row justify-between items-end gap-4 p-6 rounded-xl border shadow-sm transition-colors ${isBlackAndWhite ? '!bg-slate-900 !border-slate-800' : 'bg-white border-gray-200'}`}>
              <div>
                <h2 className={`text-2xl font-bold ${isBlackAndWhite ? 'text-white' : 'text-gray-900'}`}>Personel Yönetimi</h2>
                <p className={`mt-1 ${isBlackAndWhite ? 'text-gray-400' : 'text-gray-500'}`}>Excel ile yükle, yedek al veya manuel ekle.</p>
              </div>
              <div className="flex flex-wrap gap-2 w-full xl:w-auto justify-start xl:justify-end">
                 ...
                 <Button variant="secondary" onClick={generateTemplate} className={`text-xs px-3 ${isBlackAndWhite ? '!bg-slate-800 text-white !border-slate-700 hover:!bg-slate-700' : ''}`}>
                            ...
                            <div key={role} className={`p-5 rounded-xl shadow-sm border transition-all flex flex-col gap-4 hover-lift ${isBlackAndWhite ? '!bg-slate-800 !border-slate-700 text-white' : 'bg-white border-gray-200'}`}>
                                ...
                                <div className="space-y-3">
                                    <div className="flex justify-between items-center">
                                        ...
                                        <input 
                                            type="number" 
                                            value={roleConfigs[role]?.quotaService ?? 5} 
                                    ...
                                    <div className="flex justify-between items-center">
                                        ...
                                        <input 
                                            type="number" 
                                            value={roleConfigs[role]?.quotaEmergency ?? 2} 
                                    ...
                                    <div className="flex justify-between items-center">
                                        ...
                                        <input 
                                            type="number" 
                                            value={roleConfigs[role]?.weekendLimit ?? 2} 
